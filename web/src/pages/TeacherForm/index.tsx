            ...
            <main>
                <form onSubmit={ handleCreateClass }>
                    ...
                    <fieldset>
                        ...
                        />
                        <Input label="Custo da sua hora por aula" name="cost" value={ cost } onChange={ (event) => { setCost(event.target.value) } }/>
                    </fieldset>
                        ...
                        { scheduleItems.map((scheduleItem, index) => {
                            return (
                                <div key={ scheduleItem.week_day } className="schedule-item">
                                    ...
                                    />
                                    <Input value={ scheduleItem.from } onChange={ (event) => setScheduleItemValue(index, 'from', event.target.value) } name="from" label="Das" type="time" />
                                    <Input value={ scheduleItem.to } onChange={ (event) => setScheduleItemValue(index, 'to', event.target.value) } name="to" label="Até" type="time" />
                                </div>
                            );
                        }) }
                    </fieldset>
